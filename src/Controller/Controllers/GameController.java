...
public class GameController extends Controller{
    ...
    public GameController(GameState stateManager, ViewThread viewThread) {
        super(viewThread.getGameScreen());
//        this.canvas = viewThread.getCanvas();
        ...
        */
        ...
        getBindings().add(new Listener(Settings.P1_DOWN, ()->stateManager.execute(1,2)));
        getBindings().add(new Listener(Settings.P1_LEFT, ()->stateManager.execute(1,3)));
        getBindings().add(new Listener(Settings.P1_RIGHT, ()->stateManager.execute(1,4)));
        ...
        getBindings().add(new Listener(Settings.P2_DOWN, ()->stateManager.execute(2,2)));
        getBindings().add(new Listener(Settings.P2_LEFT, ()->stateManager.execute(2,3)));
        getBindings().add(new Listener(Settings.P2_RIGHT, ()->stateManager.execute(2,4)));
        addToJframe();
    }
    public void init() { }
